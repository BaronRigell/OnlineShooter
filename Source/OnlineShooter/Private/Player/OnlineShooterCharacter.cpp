...
#include "OnlineShooter/Public/Player/OnlineShooterCharacter.h"
...
void AOnlineShooterCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
